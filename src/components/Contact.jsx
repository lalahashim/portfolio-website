    ...
    return(
        <div className="flex flex-col gap-1 text-black dark:text-gray-100">
            ...
            <div className="flex items-center gap-2 md:gap-3">
                <a href="https://github.com/lalahashim" className="cursor-points dark:cursor-dark-points">
                ...
                <a href="www.linkedin.com/in/lalahashim" className="cursor-points dark:cursor-dark-points">
