...
export default function Projects(){
    return (
        <div className='dark:text-gray-100 text-black'>
            <h3 className="text-2xl md:text-3xl font-bold">Web projects</h3>
            <div className='flex flex-wrap items-center justify-center gap-4 mt-3'>
                {projects.map((project, index) => (
                    <div key={index} className='md:w-80 bg-gray-100 dark:bg-slate-900 rounded-lg shadow-md dark:shadow-gray-800'>
